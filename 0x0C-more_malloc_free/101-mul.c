...
/**
 * mul - multiplies a char with a string and place
 * @n: char that will multiply
...
/**
 * check_for_digits - checks on arguments to ensure they are digits
